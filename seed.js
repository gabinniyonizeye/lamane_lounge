...
const categories = [
  { name: 'coffee', description: 'Fresh brewed coffee' },
  { name: 'pastries', description: 'Delicious pastries' },
  { name: 'cakes', description: 'Custom cakes' },
  { name: 'bread', description: 'Fresh bread' },
  { name: 'donuts', description: 'Sweet donuts' },
  { name: 'cookies', description: 'Homemade cookies' },
  { name: 'drinks', description: 'Hot and cold drinks' }
];
