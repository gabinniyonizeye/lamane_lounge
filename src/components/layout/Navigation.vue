<template>
  <nav class="bg-white/95 backdrop-blur-xl border-b border-stone-200 sticky top-0 z-50 shadow-sm">
    <div class="container flex h-20 items-center justify-between gap-4">
      <router-link to="/" class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-base font-semibold text-dark">Bakery & Coffee</p>
        </div>
      </router-link>

      <div class="hidden lg:flex items-center gap-8 text-sm font-medium text-stone-600">
        ...
        <router-link to="/menu" class="transition hover:text-primary text-dark font-semibold">Menu</router-link>
      ...
      <div class="flex items-center gap-3">
        <div class="hidden lg:flex items-center rounded-full border border-stone-200 bg-slate-50 px-3 py-2 shadow-sm">
        ...
        <div class="relative">
          <button @click="toggleUserMenu" class="inline-flex h-11 w-11 items-center justify-center rounded-full border border-stone-200 bg-white text-stone-700 shadow-sm transition hover:border-primary hover:text-primary">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
