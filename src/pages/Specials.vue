<template>
  <div class="min-h-screen bg-gray-50 py-16"><div class="container">
    <div class="text-center mb-12"><p class="text-primary font-semibold uppercase tracking-widest text-sm mb-2">Limited treats</p><h1 class="section-title mb-3">Today's Specials</h1><p class="text-gray-600">A hand-picked selection from our lounge and coffee bar.</p></div>
