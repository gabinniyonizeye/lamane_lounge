  ...
  <div class="bg-stone-50">
    ...
    <section class="container py-16 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-3xl font-bold text-primary">Daily</p><p class="text-gray-600 mt-2">fresh bakes</p></div>
        <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-3xl font-bold text-primary">Custom</p><p class="text-gray-600 mt-2">cakes for moments</p></div>
        <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-3xl font-bold text-primary">Local</p><p class="text-gray-600 mt-2">community space</p></div>
        <div class="bg-white p-6 rounded-xl shadow-sm"><p class="text-3xl font-bold text-primary">Warm</p><p class="text-gray-600 mt-2">service, always</p></div>
      </div>
    </section>
  </div>
</template>
